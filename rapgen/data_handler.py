...
def build_dataset(wordlist_generator, vocabulary_size):
    """
    Reads a wordlist and converts it to datastructures around their frequency

    :param wordlist_generator: A generator of words.
    ...
    """
    counter = Counter(wordlist_generator)
    ...
    unknown_count = sum(word not in words_to_index for word in wordlist_generator)
